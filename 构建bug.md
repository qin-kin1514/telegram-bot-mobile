...
Preinstalled sdkmanager has the correct version
Accepting Android SDK licenses
/usr/local/lib/android/sdk/cmdline-tools/latest/bin/sdkmanager --licenses
...
---------------------------------------
Accept? (y/N): 
2/6: License android-googlexr-license:
---------------------------------------
...
/usr/local/lib/android/sdk/cmdline-tools/latest/bin/sdkmanager platform-tools
